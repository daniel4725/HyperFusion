...
class HyperFusion_AD_binary(nn.Module):
    def __init__(self, in_channels=1, n_outputs=3, bn_momentum=0.1, init_features=4, n_tabular_features=1, **kwargs):
        super().__init__()
        ...
        self.linear_drop2 = nn.Dropout(0.5)
        self.fc2 = LinearLayer(4*init_features, 1, **fc2_hyper_kwargs)
...
class HyperFusion_AD_untraind_tabular(nn.Module):
    def __init__(self, in_channels=1, n_outputs=3, bn_momentum=0.1, init_features=4, n_tabular_features=1, **kwargs):
        super().__init__()
        ...
        embd_tab_out_size = 8
        model = MLP_8_bn_prl(kwargs["mlp_layers_shapes"]).mlp
        hyper_embeddings_tab = nn.Sequential(
            model[0],
            model[1],
            model[2]
...
class HyperFusion_AD_hyper_first_block(nn.Module):
    def __init__(self, in_channels=1, n_outputs=3, bn_momentum=0.1, init_features=4, n_tabular_features=1, **kwargs):
        super().__init__()
        ...
        self.conv_bn_relu = conv3d_bn3d_relu(in_channels, init_features, bn_momentum=bn_momentum)
        self.max_pool3d_1 = nn.MaxPool3d(kernel_size=2, stride=2)
        self.block1 = HyperPreactivResBlock(init_features, 2 * init_features, bn_momentum=bn_momentum, dropout=0.1,
                                            **resblock_hyper_kwargs)
        self.block2 = PreactivResBlock_bn(2 * init_features, 4 * init_features, bn_momentum=bn_momentum, stride=2, dropout=0.2)
        self.block3 = PreactivResBlock_bn(4 * init_features, 8 * init_features, bn_momentum=bn_momentum, stride=2, dropout=0.2)
...
class HyperFusion_AD_hyper_second_block(nn.Module):
    def __init__(self, in_channels=1, n_outputs=3, bn_momentum=0.1, init_features=4, n_tabular_features=1, **kwargs):
        super().__init__()
        ...
        self.max_pool3d_1 = nn.MaxPool3d(kernel_size=2, stride=2)
        self.block1 = PreactivResBlock_bn(init_features, 2 * init_features, bn_momentum=bn_momentum, dropout=0.1)
        self.block2 = HyperPreactivResBlock(2 * init_features, 4 * init_features, bn_momentum=bn_momentum, stride=2, dropout=0.2,
                                            **resblock_hyper_kwargs)
        self.block3 = PreactivResBlock_bn(4 * init_features, 8 * init_features, bn_momentum=bn_momentum, stride=2, dropout=0.2)
        self.block4 = PreactivResBlock_bn(8 * init_features, 16 * init_features, bn_momentum=bn_momentum, stride=2, dropout=0.3)
        self.adaptive_avg_pool3d = nn.AdaptiveAvgPool3d(1)
...
class HyperFusion_AD_hyper_3rd_block(nn.Module):
    def __init__(self, in_channels=1, n_outputs=3, bn_momentum=0.1, init_features=4, n_tabular_features=1, **kwargs):
        super().__init__()
        ...
        self.block3 = HyperPreactivResBlock(4 * init_features, 8 * init_features, bn_momentum=bn_momentum, stride=2, dropout=0.2,
                                            **resblock_hyper_kwargs)
        self.block4 = PreactivResBlock_bn(8 * init_features, 16 * init_features, bn_momentum=bn_momentum, stride=2, dropout=0.3)
        self.adaptive_avg_pool3d = nn.AdaptiveAvgPool3d(1)
        self.linear_drop1 = nn.Dropout(0.6)
...
class HyperFusion_AD_hyper_2fc(nn.Module):
    def __init__(self, in_channels=1, n_outputs=3, bn_momentum=0.1, init_features=4, n_tabular_features=1, **kwargs):
        super().__init__()
        ...
        embd_model_path_end = f'baseline-tabular_v1-seed{kwargs["split_seed"]}-fs{kwargs["features_set"]}/fold_{kwargs["data_fold"]}/best_val.ckpt'
        embd_model_path = os.path.join(kwargs["checkpoint_dir"], embd_model_path_end)
        model1 = PlModelWrapADcls.load_from_checkpoint(embd_model_path).model.mlp
        hyper_embeddings_tab1 = nn.Sequential(
            model1[0],
            model1[1],
            model1[2]
        )

        model2 = PlModelWrapADcls.load_from_checkpoint(embd_model_path).model.mlp
        ...
        fc1_hyper_kwargs = dict(embedding_model=hyper_embeddings_tab1)
        fc2_hyper_kwargs = dict(embedding_model=hyper_embeddings_tab2)
...
class HyperFusion_AD_TFF(nn.Module):
    def __init__(self, in_channels=1, n_outputs=3, bn_momentum=0.1, init_features=4, n_tabular_features=1, **kwargs):
        super().__init__()
