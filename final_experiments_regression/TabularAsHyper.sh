...
exname="TabularAsHyperMIX_R_R_R_FFT_FF_embd8"  # the experiment name is the file name
features_set="12"
model="TabularAsHyperMIX_R_R_R_FFT_FF_embd8"
epochs="320"
class_weights="-cw 0.9550 0.6962 1.9361"  # the regular:"-cw 0.9550 0.6962 1.9361"    0.9550 1 1.85
