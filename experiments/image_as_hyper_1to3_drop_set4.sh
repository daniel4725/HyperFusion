#!/bin/bash
PYPROJ="/usr/local/faststorage/danieldu/pyproj/hyperproj/pyproj"
cd $PYPROJ

# args:
GPU="2"

exname="img_as_hyper_tabMLP_AGE1to3_drop-set4"
metadata_path="metadata_by_features_sets/set-4.csv"   # set 4 is norm minmax (0 to 1), set 5 is std-mean
model="img_as_hyper_tabMLP_AGE1to3_drop"
cnn_dropout="0.1"
init_features="32"
lr="0.0001"
L2="0.00001"
