...
cfg.experiment_name = f"baseline-tabular{vers}-seed{seed}-fs{f_set}"
cfg.data_module.dataset_cfg.only_tabular = True
cfg.model.model_name = "MLP_8_bn_prl"
cfg.data_module.dataset_cfg.features_set = f_set
cfg.trainer.epochs = 250
cfg.lightning_wrapper.loss.class_weights = [0.9550, 0.6962, 1.9361]  # the default: 0.9550 0.6962 1.9361
