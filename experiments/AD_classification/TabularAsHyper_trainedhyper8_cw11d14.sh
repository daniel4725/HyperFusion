...
exname="TabularAsHyper_embd_trainedTabular8_cw11d14$3"
features_set="$5"
model="TabularAsHyper_R_R_R_FFT_FF_embd_trainedTabular8"
epochs="260"
class_weights="-cw 1.1 0.6962 1.4"  # the regular:"-cw 0.9550 0.6962 1.9361"    0.9550 1 1.85
