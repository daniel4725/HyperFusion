...
cfg.experiment_name = f"HyperFusion_ADvsCN_binary{vers}-seed{seed}-fs{f_set}"
cfg.model.model_name = "HyperFusion_AD_binary"
cfg.data_module.dataset_cfg.features_set = f_set
cfg.trainer.epochs = 250

cfg.lightning_wrapper.wrapper_name = "PlModelWrapADcls2ClassesBinary"
