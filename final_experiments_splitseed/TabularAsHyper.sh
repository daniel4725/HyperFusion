...
exname="TabularAsHyper_R_R_R_FFT_FF_embd8_cw1$3"
features_set="$5"
model="TabularAsHyper_R_R_R_FFT_FF_embd8"
epochs="260"
class_weights="-cw 0.9550 1 1.9361"  # the regular:"-cw 0.9550 0.6962 1.9361"    0.9550 1 1.85
#class_weights=""  # the regular:"-cw 0.9550 0.6962 1.9361"    0.9550 1 1.85
split_seed="$4"
