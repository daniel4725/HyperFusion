...
# TODO change name:
#SBATCH --output=%j-PreResNet_bn_4blks_incDrop_32filt_BS64_x1.out
exname="PreResNet_bn_4blks_incDrop_32filt_BS16_x1"
model="PreactivResNet_bn_4blks_incDrop"
cnn_dropout="0.1"
init_features="32"
lr="0.0001"
L2="0.00001"
epochs="200"
batch_size="6"
tform="normalize"   # hippo_crop  hippo_crop_lNr  normalize
