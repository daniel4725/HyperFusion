...
exname="hyper_age_around1_lastHyp_smothedAGE_fix"
metadata_path="metadata_by_features_sets/set-6.csv"   # set 4 is norm minmax (0 to 1), set 5 is std-mean
model="HE_RSNT_age_noembd_lastHyp_smothedAGE"
cnn_dropout="0.1"
init_features="32"
lr="0.0001"
L2="0.00001"
