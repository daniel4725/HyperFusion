...
exname="lastblockHyp_FFT_age69cut"
metadata_path="metadata_by_features_sets/set-7.csv"   # set 4 is norm minmax (0 to 1), set 5 is std-mean
model="RSNT_age_noembd_lastblockHyp_FFT"
cnn_dropout="0.1"
init_features="32"
lr="0.0001"
L2="0.00001"
