...
# TODO change name:
#SBATCH --output=%j-PreResNet_bn_4blks_drop03_32filt_BS64_crop.out
exname="PreResNet_bn_4blks_drop03_32filt_BS64_crop"
model="PreactivResNet_bn"
cnn_dropout="0.3"
init_features="32"
lr="0.0001"
L2="0.00001"
epochs="200"
batch_size="64"
tform="hippo_crop"   # hippo_crop  hippo_crop_lNr  normalize
